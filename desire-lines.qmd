...
```{r}
#| fig-format: png
TRIPSdlines_geo_noLX = TRIPSdlines_oneway |> 
  filter(o == "Lisboa" | d == "Lisboa") # or condition
TRIPSdlines_pop_noLX = TRIPSdlines_pop |> 
  filter(o == "Lisboa" | d == "Lisboa")

mapview(TRIPSdlines_geo_noLX, color = "blue") + mapview(TRIPSdlines_pop_noLX, color = "red")
```

<!-- ## Plot desire lines with line width for number of trips -->
