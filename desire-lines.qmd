...
But if we replace those zones by the weighted centroids, we can have a more realistic representation of the flows.
...
<!-- ## Desire lines with line width for number of trips -->

<!-- ```{r} -->

<!-- plot(TRIPSdlines_oneway_noLX$geometry, lwd = TRIPSdlines_pop_noLX$Total / 20000) -->

<!-- ``` -->

<!-- Altough mapview is great for a quick visualization, it is not that easy to customize the line width. -->

<!-- tmap is a great alternative for this, altough mote complex. -->
...
<!--            # breaks = c(5000, 10000, 20000, 50000, 80000), -->

<!--            # lwd = "Total", -->

<!--            # scale = 30, -->

<!--            title.col = "Intermumicipal trips, without Lisbon") + -->

<!--   tm_shape(Centroid_pop) + -->

<!--   tm_text("group", size = 0.8, col = "gray25") -->
...
<!-- TRIPSjitter = od_jitter(TRIPSmode, z = Municipalities_geo) -->

<!-- plot(TRIPSdlines$geometry, col = "red", lwd = 2) -->

<!-- plot(TRIPSjitter$geometry, add = TRUE) -->
