...
General Transit Feed Specification (GTFS) is standardized format for documenting public transportation dataset, including routes, schedule, stop locations, and trips.
Transit agencies are responsible for maintaining the data up to date.
The data is given in .txt files and are related to one another by "id".
