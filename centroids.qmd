...
mapview(Centroids_geo) + mapview(Municipalities_geo, alpha.regions = 0) # both, with full transparency in polygons
```
...
For this, we will need the census data [@INE2021].
...
It was not that easy to estimate weighted centroids with R, as it is with GIS softwares.
But there is this [new package](https://ryanzomorrodi.github.io/centr), `centr`, that can help us.
...
See how the building, population and geometric centroids of Sintra are appart, from closer to Tagus, to the rural area.
