...
[![A visual representation of the left join where every row in x appears in the output.[^data-manipulation-3]](images/clipboard-1594422253.png){fig-align="center" width="424"}](https://r4ds.hadley.nz/joins#fig-join-left)

[^data-manipulation-3]: Source: [R for Data Science](https://r4ds.hadley.nz/).

[^data-manipulation-4]: Source: [R for Data Science](https://r4ds.hadley.nz/).
...
It takes the last result and applies the next function to it. "With this, do this.".
