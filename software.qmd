...
install.packages(listpackages, dependencies = TRUE)
```

## Other software

### Java Development Kit 21 and r5r

You will need this to work with the **r5r** package.
It is also known as JDK 21.
