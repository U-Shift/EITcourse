...
| 15.30 | *Coffee break*                                                                                                  |
| 15.45 | Introoduction to GIS and spatial data: import and visualize vector data                                         |
| 16.30 | View and export interactive maps                                                                                |
| 17.00 | *End of day 1*                                                                                                  |

| Day 2 |                                                                                    |
|-------------------|-----------------------------------------------------|
| 9.30  | Centroids and Georeferenced coordinates from survey responses                      |
| 10.30 | Desire-lines from OD pairs and transport zones                                     |
| 11.00 | *Coffee break*                                                                     |
| 11.15 | (cont.)                                                                            |
