...
Then, we will [introduce GIS and spatial data](spatia-data.qmd), learning how to importing and visualize vector data.
...
Then, we will learn how to perform [accessibility analysis](accessibility-analysis.qmd), using the r5r package.
